...
switch($type)
{
    case 'all':
        ...
        $customer_query  = "SELECT * FROM `sp_customers` WHERE `commencement_date` BETWEEN '$date_start' AND '$date_end'";
...
//SELECT `id`, `first_name`, `middle_name`, `last_name`, `commencement_date`, `renewal_date`, `phone_no`, `email_add`, `type_of_policy`, `company`, `status`, `date_created`, `full_names` FROM `sp_customers` WHERE 1
    ...
    case 'active':
        ...
        //select all from customers
        $customer_query  = "SELECT * FROM `sp_customers` WHERE `commencement_date` BETWEEN '$date_start' AND '$date_end' AND status=1";
        $customer_res    = mysqli_query($connection,$customer_query);
...
//SELECT `id`, `first_name`, `middle_name`, `last_name`, `commencement_date`, `renewal_date`, `phone_no`, `email_add`, `type_of_policy`, `company`, `status`, `date_created`, `full_names` FROM `sp_customers` WHERE 1
    ...
    case 'expired':
        ...
        $customer_query  = "SELECT * FROM `sp_customers` WHERE `commencement_date` BETWEEN '$date_start' AND '$date_end' AND status=0";
        $customer_res    = mysqli_query($connection,$customer_query);
